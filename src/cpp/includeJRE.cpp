...
int main(int argc, char* argv[]) {
    ...
    std::string jrePath = exeDir + "\\jre\\bin\\java.exe";  // Path to java.exe in the JRE folder
    ...
    commandStream << "cmd /C \"" << jrePath << " -jar " << jarPath;
    ...
    commandStream << "\""; // Close the cmd /C command
